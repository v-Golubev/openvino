...
MarkLoops::MarkLoops(size_t vector_size) : ConstRangedPass(), m_vector_size(vector_size) {}

bool MarkLoops::run(const LinearIR& linear_ir, lowered::LinearIR::constExprIt begin, lowered::LinearIR::constExprIt end) {
