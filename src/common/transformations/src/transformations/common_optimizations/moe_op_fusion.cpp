...
Convert3GatherMatmulMoeBlockToMoeOp::Convert3GatherMatmulMoeBlockToMoeOp(bool has_batch_dim) {
    ...
    matcher_pass_callback callback = [=](pattern::Matcher& m) {
        ...
        // Extract activation type and expert_beta from Swish/Gelu
        float expert_beta = 1.0f;
        auto glu_type = ov::op::internal::GLU::GluType::Swish;
        ...
        } else if (ov::is_type<v7::Gelu>(activation_node)) {
        ...
        if (is_compressed) {
            ...
            MOECompressed::Config compressed_config{
                {ov::op::internal::MOE::Expert_type::GEMM3_SWIGLU, 0.0f, expert_beta, 0, glu_type},
                gate_K,
                weight_shape[1],
                weight_shape[0],
                0,  // num_shared_expert
            ...
            ov::op::internal::MOE::Config config{ov::op::internal::MOE::Expert_type::GEMM3_SWIGLU, 0.0f, expert_beta, 0, glu_type};
