...
public:
    ...
    void appendDecompressionScales(const MemoryCPtr& scales_ptr, size_t icBlock, bool needTranspose);
    void appendDecompressionZeroPoints(const MemoryCPtr& zero_points_ptr, size_t icBlock, bool needTranspose);
...
private:
    ...
    MemoryPtr prepackDecompressionParams(const MemoryCPtr& params_ptr, size_t icBlock, bool needTranspose);
};
