...
const std::vector<InputShape> inputShape = {
    ...
    //     {{-1, -1, -1, -1}, {{1, 3, 128, 128}, {1, 3, 128, 129}, {1, 3, 128, 130}, {1, 3, 128, 1}, {1, 3, 128, 16},
    //     {1, 3, 128, 1}}},
    //     {{-1, -1, -1, 128}, {{1, 3, 128, 128}, {1, 3, 128, 128}, {1, 3, 64, 128}, {1, 3, 32, 128}, {1, 3, 64, 128},
    //     {1, 3, 32, 128}}},
    //     {{-1, -1, -1, 130}, {{1, 3, 8, 130}, {1, 3, 18, 130}, {1, 3, 8, 130}, {1, 3, 32, 130}, {1, 3, 18, 130}, {1,
    //     3, 32, 130}}},
    //     {{-1, -1, 128, -1}, {{1, 3, 128, 128}, {1, 3, 128, 129}, {1, 3, 128, 130}, {1, 3, 128, 1}, {1, 3, 128, 16},
    //     {1, 3, 128, 1}}},
};
...
struct SoftmaxBenchmarkTest : ov::test::BenchmarkLayerTest<Softmax> {};

TEST_P(SoftmaxBenchmarkTest, Softmax_Benchmark) {
    run_benchmark("Subgraph", std::chrono::milliseconds(2000), 10000);
}

INSTANTIATE_TEST_SUITE_P(smoke_Snippets_Softmax_Benchmark, SoftmaxBenchmarkTest,
        ::testing::Combine(
                ::testing::ValuesIn(inputShape),
                ::testing::Values(-1),
                ::testing::Values(1),
