...
/// Batched GEMM for GroupedMatMul: sequential write-back (no sort/scatter).
...
class GroupedMatmulBatchedGemmGenerator : public ExpertGemmBatchedGeneratorBase {
public:
    explicit GroupedMatmulBatchedGemmGenerator()
        : ExpertGemmBatchedGeneratorBase("grouped_matmul_batched", "_batched_gemm") {}
...
protected:
    ...
    [[nodiscard]] const char* get_class_name() const override { return "GroupedMatmulBatchedGemmGenerator"; }
};
