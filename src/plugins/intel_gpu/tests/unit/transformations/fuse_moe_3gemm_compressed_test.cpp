...
TEST_F(FuseMOE3GemmCompressedTest, CompareFunctions) {
    {
        ...
        auto topk_indices = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{32, 8});
        ...
        auto moe_compressed = std::make_shared<ov::intel_gpu::op::MOECompressed>(
            ov::OutputVector{hidden_states, routing_weights, topk_indices,
                wei_gate, scale_gate, zp_gate, wei_up, scale_up, zp_up, wei_down, scale_down, zp_down}, config);
        model = std::make_shared<ov::Model>(moe_compressed, ov::ParameterVector{hidden_states, routing_weights, topk_indices});
    }
    manager.register_pass<FuseMOE3GemmCompressed>();
    {
        ...
        ov::OutputVector args{hidden_states, routing_weights, topk_indices,
        ...
        model_ref = std::make_shared<ov::Model>(moe_3gemm_fused_compressed, ov::ParameterVector{hidden_states, routing_weights, topk_indices});
    }
}
